    ...
    <>
      ...
      <div className={`drawer${open?" open":""}`}>
        <div style={{padding:"18px 14px 10px",borderBottom:`1px solid ${T.soft}`}}>
          <div style={{fontFamily:"'Outfit',sans-serif",fontSize:17,fontWeight:700,color:T.primary}}>SmileTrack</div>
    ...
    <div className="mo" onClick={onClose}>
      <div className="md" onClick={e=>e.stopPropagation()}>
        <div style={{textAlign:"center",marginBottom:12}}>
          ...
          <div style={{fontFamily:"'Outfit',sans-serif",fontSize:15,fontWeight:700,color:T.primary,marginBottom:4}}>矯正ケアグッズのご紹介</div>
